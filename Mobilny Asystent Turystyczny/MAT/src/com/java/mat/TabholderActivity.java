...
public class TabholderActivity extends FragmentActivity implements TabHost.OnTabChangeListener {
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        TabholderActivity.addTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator("Mapa"), ( tabInfo = new TabInfo("Tab1", MapFragmentActivity.class, args)));
     ...
     * @param args
     */
    private static void addTab(TabholderActivity activity, TabHost tabHost, TabHost.TabSpec tabSpec, TabInfo tabInfo) {
